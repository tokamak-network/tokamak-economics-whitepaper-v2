...
While optimistic rollups rely on the straightforward assumption that there is at least one honest validator, the verifier's dilemma \cite{luu2015demystifying} still arises in blockchain systems, and related failures have been observed in practice \cite{kalodner2020arbitrum}.
