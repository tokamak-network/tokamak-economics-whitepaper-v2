...
The DAO can, for example, adjust or introduce challenge windows, slashing ratios, minimum stake requirements, or the relative weight of rewards allocated to sequencers and validators.
